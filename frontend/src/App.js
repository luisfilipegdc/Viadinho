    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#ffcbdb" : "#FFFFFF" },
				sair: { main: mode === "light" ? "#ffcbdb" : "#333" },
				vcard: { main: mode === "light" ? "#ffcbdb" : "#666" },
                textPrimary: mode === "light" ? "#ffcbdb" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#ffcbdb" : "#FFFFFF",
